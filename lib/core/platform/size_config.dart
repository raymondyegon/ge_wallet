...
class SizeConfig {
  ...
  TextStyle get h6Theme =>
      Theme.of(context).textTheme.apply(fontSizeFactor: 1).headline5!.copyWith(
  ...
  TextStyle get h4Theme =>
      Theme.of(context).textTheme.apply(fontSizeFactor: 1).headline4!.copyWith(
              fontSize: heightScaledSize(
            Theme.of(context)
                .textTheme
                .apply(fontSizeFactor: 1)
  ...
  TextStyle get h3Theme =>
      Theme.of(context).textTheme.apply(fontSizeFactor: 1).headline3!.copyWith(
            fontSize: heightScaledSize(
              Theme.of(context)
                  .textTheme
                  .apply(fontSizeFactor: 1)
  ...
  TextStyle get h2Theme =>
      Theme.of(context).textTheme.apply(fontSizeFactor: 1).headline2!.copyWith(
            fontSize: heightScaledSize(
              Theme.of(context)
                  .textTheme
                  .apply(fontSizeFactor: 1)
  ...
  TextStyle get h1Theme =>
      Theme.of(context).textTheme.apply(fontSizeFactor: 1).headline1!.copyWith(
            fontSize: heightScaledSize(
              Theme.of(context)
                  .textTheme
                  .apply(fontSizeFactor: 1)
  ...
  TextStyle get body2Theme =>
      Theme.of(context).textTheme.apply(fontSizeFactor: 1).bodyText2!.copyWith(
            fontSize: heightScaledSize(
              Theme.of(context)
                  .textTheme
                  .apply(fontSizeFactor: 1)
  ...
  TextStyle get body1Theme =>
      Theme.of(context).textTheme.apply(fontSizeFactor: 1).bodyText1!.copyWith(
            fontSize: heightScaledSize(
              Theme.of(context)
                  .textTheme
                  .apply(fontSizeFactor: 1)
  ...
  TextStyle get subtitle1Theme =>
      Theme.of(context).textTheme.apply(fontSizeFactor: 1).subtitle1!.copyWith(
            fontSize: heightScaledSize(
  ...
  TextStyle get buttonTextTheme =>
      Theme.of(context).textTheme.apply(fontSizeFactor: 1).button!.copyWith(
          fontSize:
              heightScaledSize(Theme.of(context).textTheme.button!.fontSize!));
